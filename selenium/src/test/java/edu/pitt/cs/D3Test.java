...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    assertEquals(baseUrl + "0/reset", vars.get("href").toString());
  }
  @Test
  public void tEST3CATALOG() {
    ...
    assertEquals(baseUrl + "0/images/cat2.jpg", vars.get("src").toString());
  }
  @Test
  ...
  //   driver.get("http://localhost:8080/greet-a-cat/Jennyanydots");
  //   assertThat(driver.findElement(By.xpath("//h4[contains(.,\'Meow! from Jennyanydots.\')]")).getText(), is("Jennyanydots is not here."));
  // }
  // @Test
